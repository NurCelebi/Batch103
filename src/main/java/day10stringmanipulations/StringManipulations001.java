...
public class StringManipulations001 {
    ...
    public static void main(String[] args) {
        ...
        //repeat(5) kodu a String'ini yanyana 5 kere yapistirir.
        String n = a.repeat(5);
        System.out.println(n);
        //count ==0 ise bos dondur demek


        //a.concat(a).concat(a).concat(a)..... gibi yazdirmak yerine boyle daha kisa bir skeilde yazdirabiliriz...
        //repeat methodununkullandiginda String return eder.ama repeat'i ne return ettigini
        //ctrl+e ye basarak da bulabiliriz.
