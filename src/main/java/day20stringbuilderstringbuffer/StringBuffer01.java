...
public class StringBuffer01 {
    ...
    2)StringBuffer synchronized'dir.verilen isleri siralaam becerisi.


    Senaryolar:
    1)Degistirilemez data icin String Class kullanilir.
    2)Degistirilebilir ama 'multi-thread' gerekemeyen durumlar icin "StringBuilder" kullanilir.
